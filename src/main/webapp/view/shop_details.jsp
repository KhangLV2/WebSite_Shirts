...
-----------------------*/
        ...
        .product__details__option__color label.active {
            border: 3px solid #007bff; /* viền đậm hơn khi active */
        }
...
<section class="shop-details container px-0">
                            ...
                            <ul class="nav nav-tabs" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" data-toggle="tab" href="#tabs-4" role="tab">
                                        <div class="product__thumb__pic set-bg"
                                             data-setbg="${pageContext.request.contextPath}/img/shop-details/thumb-4.png">
                        ...
                        <div class="col-lg-6 col-md-9">
                            <div class="tab-content">
                                ...
                                <div class="tab-pane" id="tabs-4" role="tabpanel">
                                    <div class="product__details__pic__item">
                                        <img src="${pageContext.request.contextPath}/img/shop-details/product-big-4.png" alt="">
...
<%--                    row d-flex justify-content-center--%>
                        <div class="col-lg-12">
                            <form action="/cua-hang/them-vao-gio" method="post">
                                <div class="product__details__text">
                                    <h4>${chiTietSanPham.idSanPham.ten}</h4>
                                    <div class="rating">
                                    ...
                                    <h3>$${chiTietSanPham.giaBan} <span>70.00</span></h3>
                                    <p>${chiTietSanPham.moTa}</p>

                                    <!-- Hidden input để gửi id sản phẩm -->
                                    <input type="hidden" name="idSanPham" value="${chiTietSanPham.idSanPham.id}" />

                                    <div class="product__details__option">
                                        <div class="product__details__option__size">
                                            <h5 style="padding-bottom: 14px;">Kích thước: <span id="selectedSize" style="font-weight: normal;"></span></h5>
                                            <c:forEach var="kichThuoc" items="${listKichThuoc}">
                                                <label>
                                                    <input type="radio" value="${kichThuoc.ten}" name="kichThuoc" required>
                                                        ${kichThuoc.ten}
                                                </label>
                                            </c:forEach>
                                        </div>
                                        <div class="product__details__option__color">
                                            <h5 style="padding: 14px 0px">Màu sắc: <span id="selectedColor" style="font-weight: normal;"></span></h5>
                                            <c:forEach var="mauSac" items="${listMauSac}">
                                                <label class="${mauSac.ma}">
                                                    <input type="radio" value="${mauSac.ten}" name="mauSac" required>
                                                </label>
                                            </c:forEach>
                                        </div>
                                    </div>
                                    ...
                                    <div class="d-flex align-items-center mb-4 pt-2">
                                        <div class="input-group quantity mr-3" style="width: 130px;">
                                            ...
                                            <input type="text" class="form-control bg-light text-center"name="soLuong" value="1">
                                            <div class="input-group-btn">
                                        ...
                                        <button type="submit" class="btn btn-dark px-3"><i class="fa fa-shopping-cart mr-1"></i> Add To Cart</button>
                                    </div>
                                </div>
                            </form>
                    ...
                    <div class="tab-pane active" id="tabs-5" role="tabpanel">
                        <div class="product__details__tab__content">
                            ...
                            <div class="product__details__tab__content__item">
                                ...
                                <p style="text-align: justify;">A Pocket PC is a handheld computer, which features
                                    many of the
                                    same
                                ...
                                <p style="text-align: justify;">As is the case with any new technology product, the
                                    cost of a
                                    Pocket PC
        ...
        <div class="row">
            <div class="col-lg-3 col-md-6 col-sm-6 col-sm-6">
                <div class="product__item">
                    <div class="product__item__pic set-bg" data-setbg="${pageContext.request.contextPath}/img/product/product-1.jpg">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-sm-6">
                <div class="product__item">
                    <div class="product__item__pic set-bg" data-setbg="${pageContext.request.contextPath}/img/product/product-2.jpg">
                        <ul class="product__hover">
                            <li><a href="#"><img src="${pageContext.request.contextPath}/img/icon/heart.png" alt=""></a></li>
                            <li><a href="#"><img src="${pageContext.request.contextPath}/img/icon/compare.png" alt=""> <span>Compare</span></a></li>
                            <li><a href="#"><img src="${pageContext.request.contextPath}/img/icon/search.png" alt=""></a></li>
                        </ul>
                    </div>
                    <div class="product__item__text">
                        <h6>Piqué Biker Jacket</h6>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-sm-6">
                <div class="product__item sale">
                    <div class="product__item__pic set-bg" data-setbg="${pageContext.request.contextPath}/img/product/product-3.jpg">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-sm-6">
                <div class="product__item">
                    <div class="product__item__pic set-bg" data-setbg="${pageContext.request.contextPath}/img/product/product-4.jpg">
                        <ul class="product__hover">
                            <li><a href="#"><img src="${pageContext.request.contextPath}/img/icon/heart.png" alt=""></a></li>
                            <li><a href="#"><img src="${pageContext.request.contextPath}/img/icon/compare.png" alt=""> <span>Compare</span></a></li>
                            <li><a href="#"><img src="${pageContext.request.contextPath}/img/icon/search.png" alt=""></a></li>
...
<script>
    ...
    $(
        ".product__color__select label, .shop__sidebar__size label,.product__details__option__color label"
    ).on("click", function () {
        $(
            ".product__color__select label, .shop__sidebar__size label,.product__details__option__color label"
        ).removeClass("active");
    ...
    //chọn vào kích thước hiện tên bên cạnh
        document.addEventListener("DOMContentLoaded", function () {
        const radios = document.querySelectorAll('input[name="kichThuoc"]');
    ...
    document.addEventListener("DOMContentLoaded", function () {
        const radios = document.querySelectorAll('input[name="mauSac"]');
